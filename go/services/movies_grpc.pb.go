...
const (
	MovieService_ListMovies_FullMethodName  = "/services.movies.MovieService/ListMovies"
	MovieService_AddMovie_FullMethodName    = "/services.movies.MovieService/AddMovie"
	MovieService_DeleteMovie_FullMethodName = "/services.movies.MovieService/DeleteMovie"
	MovieService_UpdateMovie_FullMethodName = "/services.movies.MovieService/UpdateMovie"
	MovieService_GetMovie_FullMethodName    = "/services.movies.MovieService/GetMovie"
)
...
func (c *movieServiceClient) AddMovie(ctx context.Context, in *AddMovieRequest, opts ...grpc.CallOption) (*AddMovieResponse, error) {
	...
	err := c.cc.Invoke(ctx, MovieService_AddMovie_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _MovieService_AddMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_AddMovie_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var MovieService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "services.movies.MovieService",
	...
	Metadata: "services/movies.proto",
}
